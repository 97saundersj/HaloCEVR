...
void Game::SetupConfigs()
{
	...
	c_PhysicalReloadPauseTicks_Shotgun = config.RegisterInt("PhysicalReloadPauseTicks_Shotgun", "Pause tick for the M90 shotgun", 7);
	...
	c_PhysicalReloadResumeTicks_Shotgun = config.RegisterInt("PhysicalReloadResumeTicks_Shotgun", "Resume tick for the M90 shotgun", 12);
